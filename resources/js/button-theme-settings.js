...
const enableLightMode = () => {
    body.setAttribute(
        "data-layout",
        '{"mode" : "light", "sidebar" : {"color" : "light"}}'
    );
...
const enableCondensed = () => {
    if (darkMode == "enabled") {
        body.setAttribute(
            "data-layout",
            '{"mode" : "dark", "sidebar" : {"color" : "dark", "size" : "condensed"}, "width": "fluid"}'
        );
    } else {
        body.setAttribute(
            "data-layout",
            '{"mode" : "light", "sidebar" : {"color" : "light", "size" : "condensed"}, "width": "fluid"}'
        );
    }
...
const enableDefault = () => {
    if (darkMode == "enabled") {
        body.setAttribute(
            "data-layout",
            '{"mode" : "dark", "sidebar" : {"color" : "dark", "size" : "default"}, "width": "fluid"}'
        );
    } else {
        body.setAttribute(
            "data-layout",
            '{"mode" : "light", "sidebar" : {"color" : "light", "size" : "default"}, "width": "fluid"}'
        );
    }
